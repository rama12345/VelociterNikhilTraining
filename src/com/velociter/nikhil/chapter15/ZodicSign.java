	...
	public static void main(String[] agrs) {
		...
		try
		{
		  // get the month and day from user
			...
			day = input.nextInt();
		    zodiac_sign(month, day); // call the function to find the Zodiac Sign pass month and day from user.
	}catch (InputMismatchException inputmismatchexceptionObj)
		{
		System.out.println("please Enter correct input(1234..)");
