package com.velociter.nikhil.chapter16.Exercise3;
...
public class BankOperation {
	public static void main(String[] args) {
		...
		Random randam = new Random(); // Random number generator
		Transaction transaction; // Stores a transaction
		
		int amount = 0; // stores an amount of money
		for (int i = 1; i <= transactionCount; i++) {
			amount = 50 + randam.nextInt(26); // Generate amount of $50 to $75
			...
			amount = 30 + randam.nextInt(31); // Generate amount of $30 to $60
