...
public class AddNurseServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	nurseObject.setName(request.getParameter("name"));
    	nurseObject.setPosition(request.getParameter("position"));
    	nurseObject.setSsn(Long.parseLong(request.getParameter("ssn")));
    	nurseObject.setJoinDate(request.getParameter("joindate"));
